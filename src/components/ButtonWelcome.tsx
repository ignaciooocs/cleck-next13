...
const ButtonWelcome = () => {
  ...
  return (
    <div className="flex justify-center row-start-3 row-end-4 col-start-1 col-end-5 sm:row-start-3 sm:row-end-5 sm:col-start-1 sm:col-end-3">
      <button
